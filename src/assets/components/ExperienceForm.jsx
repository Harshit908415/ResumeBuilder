...
text-sm rounded-lg"/>
                                ...
                                <input value={experience.position || ""} onChange={(e) => updateExperience(index, "position", e.target.value)} type="text" placeholder="Job Tittle"
                                    className="px-3 py-2
text-sm rounded-lg"/>
...
text-sm rounded-lg disabled:bg-gray-100"/>
                            ...
                            <label className='flex item-center gap-2'>
                                <input type="checkbox" checked={Boolean(experience.is_current)} onChange={(e) => {
                            ...
                            <div className="space-y-2">
                                <div className='flex item-center justify-between'>
                                    ...
                                    <button onClick={() => generateDescription(index)}
                                        disabled={generatingIndex === index || !experience.
                                            position || !experience.company} className='flex
items-center gap-1 px-2 py-1 text-xs bg-purple-100
